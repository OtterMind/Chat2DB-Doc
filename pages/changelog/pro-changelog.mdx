...
- 🐞【Fixed】Restored missing Approval, Authorization, Permission Application, and SQL Audit entries in Team Management, and corrected menu grouping, permission-based visibility, approval-status localization, and the application-list layout. Team owners can filter SQL audit records by SQL keyword, operator, data source, database, schema, and execution time.
