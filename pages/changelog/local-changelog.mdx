...
- 🐞【Fixed】Fixed data source tree moves in the Local edition scrambling node positions when the move fails or is interrupted: moves are now atomic.
- 🐞【Fixed】Fixed a data source created in the Local edition not staying in the selected namespace.
