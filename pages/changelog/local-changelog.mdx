...
## 5.3.3
`2026-08-10`
- 🔥【New Feature】Added secure encrypted SQLite storage with migration support for existing local data. We recommend completing the migration as soon as possible to improve local data security.
...
- 🐞【Fixed】Fixed state updates after component unmount and delayed cleanup of timers, Terminal instances, and React Roots.
