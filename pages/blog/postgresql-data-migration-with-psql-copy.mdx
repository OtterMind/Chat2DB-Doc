...
description: "Using the PostgreSQL COPY command and the psql copy meta-command for fast PostgreSQL data import and export: CSV options, permissions and large-file strategies."
